 ...
 *   https://datatables.net/download/#bs5/dt-2.0.1/date-1.5.2/sb-1.7.0/sp-2.3.0
 *
 * Included libraries:
 *   DataTables 2.0.1, DateTime 1.5.2, SearchBuilder 1.7.0, SearchPanes 2.3.0
 */
...
(function (factory) {
    ...
    DataTable.ext = _ext = {
         ...
         *  @type string
         */
        build: "bs5/dt-2.0.1/date-1.5.2/sb-1.7.0/sp-2.3.0",
                        ...
                        if (unique) {
                            ...
                            if (isHeader) {
                                ...
                                if (!columnDef.sTitle && unique) {
                                    columnDef.sTitle = cell.innerHTML.replace(
                                        /<.*?>/g,
                                        "",
                                    );
            ...
            columns: columns.map(function (column, i) {
                return {
                    ...
                    search: {
                        ...
                        fixed: Object.keys(column.searchFixed).map(
                            function (name) {
                                return {
                                    name: name,
        ...
        var run = function (s) {
            ...
            if (typeof s === "function") {
                ...
                return columns.map(function (col, idx) {
                    return s(idx, __columnData(settings, idx, 0, 0, rows))
                        ? idx
                        : null;
                });
            }
            ...
            _: function (settings, cell, classes) {
                ...
                $(settings.nTable).on(
                    ...
                    function (e, ctx, sorting) {
                        ...
                        if (
                            sortIdx === 0 &&
                            orderedColumns.length === indexes.count()
                        ) {
...
(function (factory) {
    ...
    DataTable.ext.renderer.layout.bootstrap = function (
        ...
        var row = $("<div/>", {
            class: items.full
                ? "row my-3 justify-content-md-center table-responsive-lg overflow-x-auto"
        ...
        $.each(items, function (key, val) {
            ...
            if (val.table) {
                ...
                klass = "col-md-auto me-auto mb-3 mb-md-0";
            } else if (key === "end") {
                klass = "col-md-auto ms-auto mb-3 mb-md-0";
            } else {
                klass = "col-md";
            }
    ...
    $.extend(DateTime.prototype, {
        ...
        _constructor: function () {
            ...
            if (!this.s.parts.seconds) {
                this.dom.time
                    .children("div." + classPrefix + "-seconds")
                    .remove();
                ...
                .on("click", function (e) {
                    ...
                    if (nodeName === "button") {
                        ...
                        if (parent.hasClass(classPrefix + "-iconLeft")) {
                            ...
                            parent.hasClass(classPrefix + "-iconRight")
                        ) {
                            // Next month
                            that._correctMonth(
                                that.s.display,
                            ...
                            button.parents("." + classPrefix + "-time").length
                        ) {
        ...
        _htmlMonth: function (year, month) {
            ...
            for (var i = 0, r = 0; i < cells; i++) {
                var day = new Date(Date.UTC(year, month, 1 + (i - before))),
                    selected = this.s.d
                        ? this._compareDates(day, this.s.d)
                        : false,
                ...
                if (++r === 7) {
                    if (this.c.showWeekNumber) {
                        row.unshift(
                            this._htmlWeekOfYear(i - before, month, year),
                        );
                    }
        ...
        _optionSet: function (selector, val) {
            ...
            span.html(
                selected.length !== 0 ? selected.text() : this.c.i18n.unknown,
            );
        },
    ...
    (function () {
        ...
        var Criteria = /** @class */ (function () {
            function Criteria(
                ...
                if (
                    !dataTable$3 ||
                    !dataTable$3.versionCheck ||
                    !dataTable$3.versionCheck("1.10.0")
                ) {
                    throw new Error(
                ...
                this.c = $$3.extend(
                    ...
                    {},
                    Criteria.defaults,
                    $$3.fn.dataTable.ext.searchBuilder,
                    opts,
                );
                var i18n = this.c.i18n;
                this.s = {
                ...
                this.dom = {
                    buttons: $$3("<div/>").addClass(
                        this.classes.buttonContainer,
                    ),
                ...
                $$3(window).on(
                    "resize.dtsb",
                    dataTable$3.util.throttle(function () {
            ...
            Criteria.prototype.updateArrows = function (hasSiblings) {
                ...
                if (
                    (this.c.depthLimit === false ||
                        this.s.depth < this.c.depthLimit) &&
                    hasSiblings
                ) {
            ...
            Criteria.prototype.getDetails = function (deFormatDates) {
                ...
                if (
                    ...
                    for (i = 0; i < this.s.value.length; i++) {
                        this.s.value[i] = this.s.value[i].replace(
                            /[^0-9.\-]/g,
                            "",
                        );
                    }
            ...
            Criteria.prototype.setListeners = function () {
                ...
                this.dom.data.unbind("change").on("change.dtsb", function () {
                    ...
                    var options = _this.dom.data.children(
                        "option." + _this.classes.option,
                    );
                ...
                this.dom.condition
                    ...
                    .on("change.dtsb", function () {
                        ...
                        // Need to go over every option to identify the correct selection
                        var options = _this.dom.condition.children(
                            "option." + _this.classes.option,
                        );
                        for (var i = 0; i < options.length; i++) {
                            var option = $$3(options[i]);
                            if (option.val() === _this.dom.condition.val()) {
                                _this.dom.condition.removeClass(
                                    _this.classes.italic,
                                );
                                option.prop("selected", true);
                                ...
                                for (
                                    var _i = 0,
                                        _a = Object.keys(_this.s.conditions);
                                    _i < _a.length;
                                    _i++
                                ) {
                                    var cond = _a[_i];
                                ...
                                if (
                                    ...
                                    (_this.dom.value.length === 1 &&
                                        _this.dom.value[0] === undefined)
                                ) {
                                    _this.doSearch();
                                }
                            } else {
            ...
            Criteria.prototype._populateCondition = function () {
                ...
                if (conditionsLength === 0) {
                    ...
                    if (this.s.type === null || this.s.type === undefined) {
                        ...
                        if ($$3.fn.dataTable.ext.oApi) {
                            $$3.fn.dataTable.ext.oApi._fnColumnTypes(
                    ...
                    for (
                        var _i = 0, _a = Object.keys(conditionObj);
                        _i < _a.length;
                        _i++
                    ) {
                        condition = _a[_i];
                ...
                // Otherwise we can just load them in
                    ...
                    this.dom.condition
                        ...
                        .addClass(this.classes.italic);
                    for (
                        var _b = 0, _c = Object.keys(this.s.conditions);
                        _b < _c.length;
                        _b++
                    ) {
                        condition = _c[_b];
                ...
                for (
                    var _d = 0, conditionOpts_1 = conditionOpts;
                    _d < conditionOpts_1.length;
                    _d++
                ) {
                ...
                if (
                    ...
                    // If it is a string then things get slightly more tricly
                        ...
                        for (var i = 0; i < conditionOpts.length; i++) {
                            ...
                            for (
                                var _e = 0, _f = Object.keys(this.s.conditions);
                                _e < _f.length;
                                _e++
                            ) {
                                var cond = _f[_e];
                                condName =
                                    this.s.conditions[cond].conditionName;
                                if (
            ...
            Criteria.prototype._populateValue = function (loadedCriteria) {
                ...
                if (loadedCriteria !== undefined) {
                    this.s.dt.columns().every(function (index) {
                        if (
                            _this.s.dt.settings()[0].aoColumns[index].sTitle ===
                            loadedCriteria.data
                        ) {
            ...
            Criteria.initSelect = function (that, fn, preDefined, array) {
                ...
                for (
                    var _i = 0, indexArray_1 = indexArray;
                    _i < indexArray_1.length;
                    _i++
                ) {
            ...
            Criteria.initSelectSSP = function (that, fn, preDefined) {
                ...
                var options = [];
                for (
                    var _i = 0, _a = that.s.serverData[that.s.origData];
                    _i < _a.length;
                    _i++
                ) {
                    var option = _a[_i];
                    ...
                    if (element.is("select")) {
                        values.push(
                            Criteria._escapeHTML(
                                element.children("option:selected").data("sbv"),
                            ),
                        );
                    }
                }
            ...
            Criteria.updateListener = function (that, el, code) {
                ...
                if (idx !== null) {
                    ...
                    if (cursorPos !== null) {
                        that.dom.value[idx][0].setSelectionRange(
                            cursorPos,
                            cursorPos,
                        );
                    }
            ...
            Criteria.luxonDateConditions = {
                ...
                between: {
                    ...
                    isInputValid: Criteria.isInputValidInput,
                    search: function (value, comparison, that) {
                        var val = luxon().DateTime.fromFormat(
                            value,
                            that.s.dateFormat,
                        ).ts;
                        var comp0 = luxon().DateTime.fromFormat(
                            comparison[0],
                            that.s.dateFormat,
                        ).ts;
                        var comp1 = luxon().DateTime.fromFormat(
                            comparison[1],
                            that.s.dateFormat,
                        ).ts;
                        if (comp0 < comp1) {
                ...
                starts: {
                    ...
                    search: function (value, comparison) {
                        return (
                            value
                                .toLowerCase()
                                .indexOf(comparison[0].toLowerCase()) === 0
                        );
                    },
                },
                "!starts": {
        ...
        var Group = /** @class */ (function () {
            function Group(
                ...
                if (
                    !dataTable$2 ||
                    !dataTable$2.versionCheck ||
                    !dataTable$2.versionCheck("1.10.0")
                ) {
                    throw new Error(
                        "SearchBuilder requires DataTables 1.10 or newer",
                    );
                }
                ...
                this.dom = {
                    ...
                    logic: $$2("<button><div/></button>")
                        ...
                        .addClass(this.classes.button)
                        .attr("type", "button"),
                    logicContainer: $$2("<div/>").addClass(
                        this.classes.logicContainer,
                    ),
                    search: $$2("<button/>")
            ...
            Group.prototype.getDetails = function (deFormatDates) {
                ...
                for (var _i = 0, _a = this.s.criteria; _i < _a.length; _i++) {
                    ...
                    details.criteria.push(
                        crit.criteria.getDetails(deFormatDates),
                    );
                }
                return details;
            };
            ...
            Group.prototype.rebuild = function (loadedDetails) {
                ...
                if (Array.isArray(loadedDetails.criteria)) {
                    for (
                        var _i = 0, _a = loadedDetails.criteria;
                        _i < _a.length;
                        _i++
                    ) {
                        crit = _a[_i];
            ...
            Group.prototype.redrawContents = function () {
                ...
                for (var i = 0; i < this.s.criteria.length; i++) {
                    ...
                    if (crit instanceof Criteria) {
                        ...
                        crit instanceof Group &&
                        crit.s.criteria.length > 0
                    ) {
                        // Reset the index to the new value
                        this.s.criteria[i].index = i;
                        this.s.criteria[i].criteria.s.index = i;
            ...
            Group.prototype.addCriteria = function (crit) {
                ...
                var index =
                    crit === null ? this.s.criteria.length : crit.s.index;
                ...
                for (var i = 0; i < this.s.criteria.length; i++) {
                    if (
                        ...
                        criteria
                            .getNode()
                            .insertBefore(
                                this.s.criteria[i].criteria.dom.container,
                            );
                        inserted = true;
                    } else if (
            ...
            Group.prototype.checkFilled = function () {
                for (var _i = 0, _a = this.s.criteria; _i < _a.length; _i++) {
                    var crit = _a[_i];
                    if (
                        (crit.criteria instanceof Criteria &&
                            crit.criteria.s.filled) ||
                ...
                if (this.s.criteria.length <= 1 && this.s.isChild) {
                    ...
                    for (i = 0; i < this.s.criteria.length; i++) {
                        if (
                            ...
                            (!group ||
                                this.s.criteria[i].criteria instanceof Group)
                        ) {
                            last = i;
                        }
                    }
            ...
            Group.prototype._setCriteriaListeners = function (criteria) {
                ...
                criteria.dom["delete"]
                    ...
                    .on("click.dtsb", function () {
                        ...
                        for (
                            var _i = 0, _a = _this.s.criteria;
                            _i < _a.length;
                            _i++
                        ) {
                            var crit = _a[_i];
                            if (crit.criteria instanceof Criteria) {
                                crit.criteria.updateArrows(
                                    _this.s.criteria.length > 1,
                                );
                            }
                        }
                        criteria.destroy();
            ...
            Group.prototype._setup = function () {
                this.setListeners();
                this.dom.add.html(
                    this.s.dt.i18n("searchBuilder.add", this.c.i18n.add),
                );
        ...
        var SearchBuilder = /** @class */ (function () {
            function SearchBuilder(builderSettings, opts) {
                ...
                if (
                    ...
                    !dataTable$1.versionCheck("1.10.0")
                ) {
                    throw new Error(
                        "SearchBuilder requires DataTables 1.10 or newer",
                    );
                ...
                if (this.s.dt.page.info().serverSide) {
                    this.s.dt.on("preXhr.dtsb", function (e, settings, data) {
                        ...
                        if (loadedState && loadedState.searchBuilder) {
                            data.searchBuilder = _this._collapseArray(
            ...
            SearchBuilder.prototype._applyPreDefDefaults = function (preDef) {
                var _this = this;
                if (
                    preDef.criteria !== undefined &&
                    preDef.logic === undefined
                ) {
                    preDef.logic = "AND";
                }
                var _loop_1 = function (crit) {
                    ...
                    if (crit.criteria !== undefined) {
                        ...
                        this_1.s.dt.columns().every(function (index) {
                            if (
                                _this.s.dt.settings()[0].aoColumns[index]
                                    .sTitle === crit.data
                            ) {
                                crit.dataIdx = index;
                            }
            ...
            SearchBuilder.prototype._setUp = function (loadState) {
                ...
                if (!dataTable$1.DateTime) {
                    ...
                    if (
                        ...
                        types = [];
                        for (
                            var _i = 0, _a = this.s.dt.settings()[0].aoColumns;
                            _i < _a.length;
                            _i++
                        ) {
                            var colInit = _a[_i];
                    ...
                    if (
                        ...
                        if ($$1.fn.dataTable.ext.oApi) {
                            $$1.fn.dataTable.ext.oApi._fnColumnTypes(
                                this.s.dt.settings()[0],
                            );
                        }
                ...
                if (loadState) {
                    ...
                    if (
                        ...
                        this.s.topGroup.dom.container.trigger(
                            "dtsb-redrawContents",
                        );
                        // If using SSP we want to restrict the amount of server calls that take place
            ...
            SearchBuilder.prototype._build = function () {
                ...
                this.s.dt.on("destroy.dtsb", function () {
                    ...
                    var searchIdx = $$1.fn.dataTable.ext.search.indexOf(
                        _this.s.search,
                    );
                    while (searchIdx !== -1) {
                        $$1.fn.dataTable.ext.search.splice(searchIdx, 1);
                        searchIdx = $$1.fn.dataTable.ext.search.indexOf(
                            _this.s.search,
                        );
                    }
                    _this.s.dt.off(".dtsb");
            ...
            SearchBuilder.prototype._setRedrawListener = function () {
                ...
                this.s.topGroup.dom.container.unbind(
                    "dtsb-redrawContents-noDraw",
                );
                this.s.topGroup.dom.container.on(
        ...
        DataTable.ext.buttons.searchBuilder = {
            action: function (e, dt, node, config) {
                ...
                if (topGroup !== undefined) {
                    topGroup.dom.container.trigger(
                        "dtsb-redrawContents-noDraw",
                    );
                }
    ...
    (function () {
        ...
        var SearchPane = /** @class */ (function () {
            ...
            function SearchPane(
                ...
                this.dom = {
                    buttonGroup: $$5("<div/>").addClass(
                        this.classes.buttonGroup,
                    ),
                    clear: $$5('<button type="button">&#215;</button>')
                        ...
                        .html(
                            this.s.dt.i18n(
                                "searchPanes.clearPane",
                                this.c.i18n.clearPane,
                            ),
                        ),
                    collapseButton: $$5(
                    ...
                    searchLabelCont: $$5("<div/>").addClass(
                ...
                this.s.searchFunction = function (
                    settings,
                    searchData,
                    dataIndex,
                ) {
                ...
                if (this.c.clear) {
                    this.dom.clear.on("click.dtsp", function () {
                        var searches = _this.dom.container.find(
                            "." + _this.classes.search.replace(/\s+/g, "."),
                        );
             ...
             */
            SearchPane.prototype.addRow = function (
                display,
                filter,
                sort,
                type,
            ...
            SearchPane.prototype.adjustTopRow = function () {
                ...
                var subRow1 = this.dom.container.find(
                    "." + this.classes.subRow1.replace(/\s+/g, "."),
                );
                var subRow2 = this.dom.container.find(
                    "." + this.classes.subRow2.replace(/\s+/g, "."),
                );
                var topRow = this.dom.container.find(
                    "." + this.classes.topRow.replace(/\s+/g, "."),
                );
                // If the width is 0 then it is safe to assume that the pane has not yet been displayed.
                //  Even if it has, if the width is 0 it won't make a difference if it has the narrow class or not
                if (
                    ($$5(subContainers[0]).width() < 252 ||
                        $$5(topRow[0]).width() < 252) &&
                    $$5(subContainers[0]).width() !== 0
                ) {
            ...
            SearchPane.prototype.collapse = function () {
                ...
                $$5(this.s.dtPane.table().container()).addClass(
                    this.classes.hidden,
                );
            ...
            SearchPane.prototype.destroy = function () {
                ...
                this.dom.container.detach();
                var searchIdx = $$5.fn.dataTable.ext.search.indexOf(
                    this.s.searchFunction,
                );
                while (searchIdx !== -1) {
                    $$5.fn.dataTable.ext.search.splice(searchIdx, 1);
                    searchIdx = $$5.fn.dataTable.ext.search.indexOf(
                        this.s.searchFunction,
                    );
                }
            ...
            SearchPane.prototype.emptyMessage = function () {
                ...
                if (
                    ...
                    this.s.colOpts.emptyMessage !== null
                ) {
            ...
            SearchPane.prototype.setListeners = function () {
                ...
                this.s.dtPane.off("select.dtsp").on("select.dtsp", function () {
                    ...
                    _this.dom.clear
                        .removeClass(_this.classes.disabledButton)
                        .removeAttr("disabled");
                });
                    ...
                    .on("deselect.dtsp", function () {
                        _this.s.deselectTimeout = setTimeout(function () {
                            ...
                            if (
                                ...
                                _this.dom.clear
                                    .addClass(_this.classes.disabledButton)
                                    .attr("disabled", "true");
                            }
                        }, 50);
                    });
                    ...
                    this.s.dt.on(
                        ...
                        function (e, settings, data) {
                            ...
                            if (_this.s.dtPane) {
                                ...
                                collapsed = _this.dom.collapseButton.hasClass(
                                    _this.classes.rotated,
                                );
                            }
                            ...
                            for (
                                var i = 0;
                                i < data.searchPanes.panes.length;
                                i++
                            ) {
                                if (
                                    data.searchPanes.panes[i].id ===
                                    _this.s.index
                                ) {
                ...
                this.s.dtPane
                    ...
                    .on(
                        "user-select.dtsp",
                        function (e, _dt, type, cell, originalEvent) {
                ...
                this.dom.nameButton
                    .off("click.dtsp")
                    .on("click.dtsp", function () {
                        var currentOrder = _this.s.dtPane.order()[0][1];
                        _this.s.dtPane
                            .order([0, currentOrder === "asc" ? "desc" : "asc"])
                            .draw();
                ...
                //  change the ordering to whatever it isn't currently
                this.dom.countButton
                    .off("click.dtsp")
                    .on("click.dtsp", function () {
                        var currentOrder = _this.s.dtPane.order()[0][1];
                        _this.s.dtPane
                            .order([1, currentOrder === "asc" ? "desc" : "asc"])
                            .draw();
                        // This state save is required so that the ordering of the panes is maintained
                        _this.s.dt.state.save();
                    });
                ...
                this.dom.collapseButton
                    ...
                    .on("click.dtsp", function (e) {
                        ...
                        _this.dom.nameButton.toggleClass(
                            _this.classes.disabledButton,
                        );
                        _this.dom.countButton.toggleClass(
                            _this.classes.disabledButton,
                        );
                        _this.dom.searchButton.toggleClass(
                            _this.classes.disabledButton,
                        );
                        _this.dom.collapseButton.toggleClass(
                            _this.classes.rotated,
                        );
                ...
                this.dom.clear.off("click.dtsp").on("click.dtsp", function () {
                    var searches = _this.dom.container.find(
                        "." + _this.classes.search.replace(/ /g, "."),
                    );
                    searches.each(function () {
            ...
            SearchPane.prototype._serverPopulate = function (dataIn) {
                ...
                if (dataIn.searchPanes.options[colTitle]) {
                    for (
                        var _i = 0, _a = dataIn.searchPanes.options[colTitle];
                        _i < _a.length;
                        _i++
                    ) {
                        var dataPoint = _a[_i];
                ...
                var uniqueRatio = this._uniqueRatio(
                    binLength,
                    this.s.tableLength,
                );
            ...
            SearchPane.prototype.show = function () {
                ...
                $$5(this.s.dtPane.table().container()).removeClass(
                    this.classes.hidden,
                );
                this.dom.topRow.trigger("collapse.dtsps");
            };
            ...
            SearchPane.prototype._getComparisonRows = function () {
                ...
                for (
                    ...
                    var insert =
                        comp.label !== "" ? comp.label : this.emptyMessage();
                    var comparisonObj = {
                        className: comp.className,
                        display: insert,
                        filter:
                            typeof comp.value === "function" ? comp.value : [],
                        sort: comp.order !== undefined ? comp.order : insert,
                        total: 0,
                        type: insert,
                    };
            ...
            SearchPane.prototype._getPaneConfig = function () {
                ...
                return {
                    columnDefs: [
                        ...
                        {
                            className:
                                "dtsp-countColumn " + this.classes.badgePill,
                            data: "total",
                            searchable: false,
                            targets: 1,
                            visible: false,
             ...
             */
            SearchPane.prototype._populatePaneArray = function (
                rowIdx,
                arrayFilter,
                settings,
                bins,
            ...
            SearchPane.prototype._reloadSelect = function (loadedFilter) {
                ...
                for (
                    var i = 0;
                    i < loadedFilter.searchPanes.panes.length;
                    i++
                ) {
                ...
                if (idx) {
                    ...
                    for (
                        var _i = 0,
                            _a = loadedFilter.searchPanes.panes[idx].selected;
                        _i < _a.length;
                        _i++
                    ) {
                        var filter = _a[_i];
            ...
            SearchPane.prototype._updateSelection = function (notUpdating) {
                ...
                var run = function () {
                    _this.s.scrollTop = $$5(
                        _this.s.dtPane.table().node(),
                    ).parent()[0].scrollTop;
                    if (
                        _this.s.dt.page.info().serverSide &&
                        !_this.s.updating
                    ) {
             ...
             */
            SearchPane.prototype._addOption = function (
                filter,
                display,
                sort,
                type,
                ...
                if (
                    ...
                    filter instanceof dataTable$2.Api
                ) {
            ...
            SearchPane.prototype._buildPane = function (
                ...
                if (this.s.colExists) {
                    ...
                    if (
                        ...
                        for (
                            ...
                            if (
                                loadedFilter.searchPanes.panes[i].id ===
                                this.s.index
                            ) {
                                idx = i;
                                break;
                    ...
                    if (
                        ...
                        if (this.s.rowData.arrayFilter.length === 0) {
                            this.s.rowData.totalOptions = 0;
                            this._populatePane();
                            this.s.rowData.arrayOriginal =
                                this.s.rowData.arrayFilter;
                            this.s.rowData.binsOriginal = this.s.rowData.bins;
                        }
                        var binLength = Object.keys(
                            this.s.rowData.binsOriginal,
                        ).length;
                        var uniqueRatio = this._uniqueRatio(
                            binLength,
                            this.s.dt.rows()[0].length,
                        );
                ...
                if (
                    prevEl !== null &&
                    this.dom.panesContainer.has(prevEl).length > 0
                ) {
                ...
                if (this.s.colExists) {
                    ...
                    for (
                        var j = 0, jen = this.s.rowData.arrayFilter.length;
                        j < jen;
                        j++
                    ) {
                        if (this.s.dt.page.info().serverSide) {
                            ...
                            for (
                                var _i = 0, _a = this.s.serverSelect;
                                _i < _a.length;
                                _i++
                            ) {
                                var option = _a[_i];
                ...
                this.s.listSet = true;
                for (
                    var _b = 0, selectedRows_1 = selectedRows;
                    _b < selectedRows_1.length;
                    _b++
                ) {
                    ...
                    if (selection) {
                        for (
                            var _c = 0,
                                _d = this.s.dtPane.rows().indexes().toArray();
                            _c < _d.length;
                            _c++
                        ) {
                            row = _d[_c];
                ...
                if (
                    ...
                    loadedFilter.searchPanes &&
                    loadedFilter.searchPanes.panes &&
                    (!dataIn || dataIn.draw === 1)
                ) {
                    this._reloadSelect(loadedFilter);
                    for (
                        var _e = 0, _f = loadedFilter.searchPanes.panes;
                        _e < _f.length;
                        _e++
                    ) {
                        var pane = _f[_e];
            ...
            SearchPane.prototype._populatePane = function () {
                ...
                if (!this.s.dt.page.info().serverSide) {
                    for (
                        var _i = 0, _a = this.s.dt.rows().indexes().toArray();
                        _i < _a.length;
                        _i++
                    ) {
                        var index = _a[_i];
        ...
        var SearchPaneST = /** @class */ (function (_super) {
            ...
            SearchPaneST.prototype._serverPopulate = function (dataIn) {
                ...
                if (dataIn.searchPanes.options[colTitle] !== undefined) {
                    for (
                        ...
                        this.s.rowData.binsShown[dataPoint.value] =
                            +dataPoint.count;
                        this.s.rowData.bins[dataPoint.value] = +dataPoint.total;
                    }
                }
                ...
                if (this.s.dtPane) {
                    ...
                    for (
                        var _b = 0, _c = this.s.rowData.arrayFilter;
                        _b < _c.length;
                        _b++
                    ) {
                        data = _c[_b];
                    ...
                    for (
                        var _d = 0, selected_1 = selected;
                        _d < selected_1.length;
                        _d++
                    ) {
                        selection = selected_1[_d];
                        for (
                            var _e = 0, _f = this.s.rowData.arrayOriginal;
                            _e < _f.length;
                            _e++
                        ) {
                            data = _f[_e];
            ...
            SearchPaneST.prototype.updateRows = function () {
                ...
                var _loop_1 = function (row) {
                    row.shown =
                        typeof this_1.s.rowData.binsShown[row.filter] ===
                        "number"
                ...
                for (
                    var _b = 0, _c = this.s.dtPane.rows().data().toArray();
                    _b < _c.length;
                    _b++
                ) {
                    var row = _c[_b];
             ...
             */
            SearchPaneST.prototype._updateShown = function (
                rowIdx,
                settings,
                bins,
            ) {
                ...
                var orth =
                    typeof this.s.colOpts.orthogonal === "string"
                        ? this.s.colOpts.orthogonal
                        : this.s.colOpts.orthogonal.search;
        ...
        var SearchPaneViewTotal = /** @class */ (function (_super) {
            ...
            SearchPaneViewTotal.prototype._getMessage = function (row) {
                var countMessage = this.s.dt.i18n(
                    "searchPanes.count",
                    this.c.i18n.count,
                );
                var filteredMessage = this.s.dt.i18n(
            ...
            SearchPaneCascade.prototype.updateRows = function () {
                ...
                if (
                    ...
                    for (var i = 0; i < rows.length; i++) {
                        ...
                        for (
                            var _i = 0, selected_1 = selected;
                            _i < selected_1.length;
                            _i++
                        ) {
                    ...
                    for (
                        var _c = 0, _d = this.s.rowData.arrayFilter;
                        _c < _d.length;
                        _c++
                    ) {
                        var data = _d[_c];
                    ...
                    for (
                        var _e = 0, selected_2 = selected;
                        _e < selected_2.length;
                        _e++
                    ) {
                        selection = selected_2[_e];
                        for (
                            var _f = 0, _g = this.s.rowData.arrayOriginal;
                            _f < _g.length;
                            _f++
                        ) {
                            var origData = _g[_f];
                            if (origData.filter === selection.filter) {
                                var addedRow = this.addRow(
                                    origData.display,
                                    origData.filter,
                                    origData.sort,
                                    origData.type,
        ...
        var SearchPaneCascadeViewTotal = /** @class */ (function (_super) {
             ...
             */
            SearchPaneCascadeViewTotal.prototype._activePopulatePane =
                function () {
                    this.s.rowData.arrayFilter = [];
                    this.s.rowData.binsShown = {};
                    var settings = this.s.dt.settings()[0];
        ...
        var SearchPanes = /** @class */ (function () {
            function SearchPanes(paneSettings, opts, fromPreInit, paneClass) {
                ...
                this.dom = {
                    ...
                    collapseAll: $$1('<button type="button"/>')
                        ...
                        .html(
                            table.i18n(
                                "searchPanes.collapseMessage",
                                this.c.i18n.collapseMessage,
                            ),
                        ),
                    container: $$1("<div/>")
                        ...
                        .html(
                            table.i18n(
                                ...
                                this.c.i18n.loadMessage,
                            ),
                        ),
                    emptyMessage: $$1("<div/>").addClass(
                ...
                if (this.s.dt.page.info().serverSide) {
                    ...
                    this.s.dt.on("preXhr.dtsps", function (e, settings, data) {
                        ...
                        var src;
                        for (
                            var _i = 0, _a = _this.s.selectionList;
                            _i < _a.length;
                            _i++
                        ) {
                            var selection = _a[_i];
            ...
            SearchPanes.prototype.clearSelections = function () {
                ...
                for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                    pane = _a[_i];
                    if (pane.s.dtPane) {
                        pane.s.scrollTop = pane.s.dtPane
                            .table()
                            .node().parentNode.scrollTop;
                    }
                }
                // Load in all of the searchBoxes in the documents
                var searches = this.dom.container.find(
                    "." + this.classes.search.replace(/\s+/g, "."),
                );
            ...
            SearchPanes.prototype.resizePanes = function () {
                ...
                if (this.c.layout === "auto") {
                    var contWidth = $$1(
                        this.s.dt.searchPanes.container(),
                    ).width();
            ...
            SearchPanes.prototype._stateLoadListener = function () {
                ...
                var hostSettings = this.s.dt.settings()[0];
                this.s.dt.on(
                    "stateLoadParams.dtsps",
                    function (e, settings, data) {
                        if (
                            data.searchPanes === undefined ||
            ...
            SearchPanes.prototype._checkCollapse = function () {
                ...
                for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                    ...
                    if (pane.s.displayed) {
                        ...
                        if (
                            !pane.dom.collapseButton.hasClass(
                                pane.classes.rotated,
                            )
                        ) {
            ...
            SearchPanes.prototype._makeSelections = function (selectList) {
                for (
                    var _i = 0, selectList_1 = selectList;
                    _i < selectList_1.length;
                    _i++
                ) {
                    ...
                    if (pane && pane.s.dtPane) {
                        for (
                            var j = 0;
                            j < pane.s.dtPane.rows().data().toArray().length;
                            j++
                        ) {
                            if (
                                selection.rows.includes(
                                    typeof pane.s.dtPane.row(j).data()
                                        .filter === "function"
             ...
             */
            SearchPanes.prototype._paneDeclare = function (
                table,
                paneSettings,
                opts,
            ) {
                ...
                table
                    .columns(
                        this.c.columns.length > 0 ? this.c.columns : undefined,
                    )
                    .eq(0)
                    .each(function (idx) {
                        _this.s.panes.push(
                            new _this.s.paneClass(
                                paneSettings,
                                opts,
                                idx,
                                _this.dom.panes,
            ...
            SearchPanes.prototype._startup = function (table) {
                ...
                for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                    var pane = _a[_i];
                    pane.rebuildPane(
                        Object.keys(this.s.serverData).length > 0
                            ? this.s.serverData
                            : undefined,
                    );
                    this.dom.panes.append(pane.dom.container);
                ...
                table
                    ...
                    .on("page.dtsps page-nc.dtsps", function (e, s) {
                        _this.s.paging = true;
                ...
                if (this.s.dt.page.info().serverSide) {
                    table
                        .off("preXhr.dtsps")
                        .on("preXhr.dtsps", function (e, settings, data) {
                            if (settings !== hostSettings) {
                                return;
                            }
                            if (!data.searchPanes) {
                            ...
                            for (
                                ...
                                if (pane.s.dtPane) {
                                    ...
                                    for (var i = 0; i < rowData.length; i++) {
                                        data.searchPanes[src][i] =
                                            rowData[i].filter;
                                        if (!data.searchPanes[src][i]) {
                                            data.searchPanes_null[src][i] =
                                                true;
                                        } else {
                                            data.searchPanes_null[src][i] =
                                                false;
                            ...
                            if (filterCount > 0) {
                                ...
                                // Otherwise it is a paging request and we need to read from whatever the paging has been set to
                                    ...
                                    data.start =
                                        _this.s.page * _this.s.dt.page.len();
                                }
                    ...
                    table.on("preXhr.dtsps", function () {
                        return _this.s.panes.forEach(function (pane) {
                            return pane.clearData();
                        });
                    });
                }
            ...
            SearchPanes.prototype._updateFilterCount = function () {
                ...
                if (
                    ...
                    typeof this.c.filterChanged === "function"
                ) {
        ...
        var SearchPanesST = /** @class */ (function (_super) {
             ...
             */
            SearchPanesST.prototype._initSelectionListeners = function (
                isPreselect,
                preSelect,
            ) {
            ...
            SearchPanesST.prototype._stateLoadListener = function () {
                ...
                this.s.dt
                    .off("stateLoadParams.dtsps", stateLoadFunction)
                    .on("stateLoadParams.dtsps", stateLoadFunction);
            };
            /**
            ...
            SearchPanesST.prototype._updateSelectionList = function (paneIn) {
                ...
                if (this.s.pagingST) {
                    ...
                    this.s.updating ||
                    (paneIn && paneIn.s.serverSelecting)
                ) {
                    return;
                }
                if (paneIn !== undefined) {
                    ...
                    this.s.selectionList = this.s.selectionList.filter(
                        function (selection) {
            ...
            SearchPanesST.prototype._remakeSelections = function () {
                ...
                if (!this.s.dt.page.info().serverSide) {
                    ...
                    for (
                        var _b = 0, _c = this.s.selectionList;
                        _b < _c.length;
                        _b++
                    ) {
                        var selection = _c[_b];
                        ...
                        for (
                            ...
                            if (currPane.s.displayed) {
                                ...
                                if (
                                    anotherFilter ||
                                    pane.s.index !== currPane.s.index ||
                                    !filteringActive
                                ) {
                                    currPane.s.filteringActive =
                                        filteringActive || anotherFilter;
                    ...
                    for (var _l = 0, _m = this.s.panes; _l < _m.length; _l++) {
                        currPane = _m[_l];
                        if (
                            currPane.s.displayed &&
                            (!pane || currPane.s.index !== pane.s.index)
                        ) {
                            currPane.updateRows();
                        }
                    }
        ...
        apiRegister(
            ...
            function (targetIdx, maintainSelections) {
                return this.iterator("table", function (ctx) {
                    if (ctx._searchPanes) {
            ...
            action: function (e, dt, node, config) {
                ...
                if (!config._panes) {
                    ...
                    setTimeout(function () {
                        ...
                        $("table.dataTable", config._panes.getNode())
                            .DataTable()
                            .columns.adjust();
        ...
        function _buttonSourced(dt, node, config) {
            ...
            var panes =
                buttonOpts && (buttonOpts.cascadePanes || buttonOpts.viewTotal)
        ...
        function _init(settings, options, fromPre) {
            ...
            var searchPanes =
                opts && (opts.cascadePanes || opts.viewTotal)

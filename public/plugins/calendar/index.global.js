...
var FullCalendar = (function (exports) {
    ...
    class BgEvent extends BaseComponent {
        render() {
            ...
            return (y(EventContainer, {
                ...
                defaultGenerator: renderInnerContent$5,
                seg: seg,
                timeText: "",
                isDragging: false,
                isResizing: false,
    ...
    */
    ...
    StandardTheme.prototype.classes = {
        ...
        button: 'fc-button fc-button-primary btn btn-primary',
    ...
    class TableListItemEvent extends BaseComponent {
        render() {
            ...
            return (y(EventContainer, Object.assign({}, props, {
                ...
                defaultGenerator: renderInnerContent$4,
                timeText: timeText,
                isResizing: false,
                isDateSelecting: false
            })));
    ...
    class TimeCol extends BaseComponent {
        ...
        renderPositionedFgSegs(segs, // if not mirror, needs to be sorted
            ...
            let {
                segPlacements,
                hiddenGroups
            } = computeFgSegPlacements$1(segs, segVCoords, eventOrderStrict, eventMaxStack);
            return (y(_, null,
    ...
    */
    ...
    class TimelineHeaderTh extends BaseComponent {
        ...
        render() {
            ...
            return (y(ContentContainer, {
                ...
                didMount: options.slotLabelDidMount,
                willUnmount: options.slotLabelWillUnmount
            }, (InnerContent) => (y("div", {className: "fc-timeline-slot-frame", style: {height: props.rowInnerHeight}},
                y(InnerContent, {
                    elTag: "a", elClasses: [
            ...
            return (y(_, null, cellRows.map((rowCells, rowLevel) => {
                ...
                return ( // eslint-disable-next-line react/no-array-index-key
                    y("tr", {
                        key: rowLevel,
                        className: classNames.join(' ')
                    }, rowCells.map((cell) => (y(TimelineHeaderTh, {
    ...
    class TimelineHeader extends BaseComponent {
        ...
        render() {
            ...
            return (y(NowTimer, {unit: timerUnit}, (nowDate, todayRange) => (y("div", {
                ...
                context.options.nowIndicator && (
                    ...
                    y("div", {className: "fc-timeline-now-indicator-container"}, (slatCoords && slatCoords.isDateInRange(nowDate)) && (y(NowIndicatorContainer, {
    ...
    class TimelineSlatCell extends BaseComponent {
        render() {
            ...
            return (y(ContentContainer, {
                ...
                didMount: options.slotLaneDidMount,
                willUnmount: options.slotLaneWillUnmount
            }, (InnerContent) => (y(InnerContent, {elTag: "div"}))));
        }
    }
    ...
    class TimelineLaneMoreLink extends BaseComponent {
        render() {
            ...
            return (y(MoreLinkContainer, {
                ...
                elStyle: Object.assign({visibility: isVisible ? '' : 'hidden', top: top || 0}, hStyle),
                allDayDate: null,
                ...
                todayRange: props.todayRange,
                extraDateSpan: extraDateSpan,
                popoverContent: () => (y(_, null, hiddenSegs.map((seg) => {
                    let instanceId = seg.eventRange.instance.instanceId;
                    return (y("div", {
                            key: instanceId,
        ...
        renderFgSegs(segPlacements, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            return (y(_, null, segPlacements.map((segPlacement) => {
                ...
                return (y("div", {
                        ...
                        style: Object.assign({visibility: isVisible ? '' : 'hidden', top: top || 0}, hStyle)
                    },
                    y(TimelineEvent, Object.assign({
                        isTimeScale: props.tDateProfile.isTimeScale,
                        seg: seg,
        ...
        render() {
            ...
            let sections = [
                ...
                },
                {
                    ...
                    chunks: [{
                        key: 'timeline',
                        content: (contentArg) => (y(TimelineGrid, Object.assign({}, props, {
                            clientWidth: contentArg.clientWidth,
                            clientHeight: contentArg.clientHeight,
                            tableMinWidth: contentArg.tableMinWidth,
                            tableColGroupNode: contentArg.tableColGroupNode,
    ...
    */
    ...
    class ResourceCell extends BaseComponent {
        render() {
            let {props} = this;
            return (y(ResourceLabelContainer, {
                elTag: "th", elClasses: ['fc-col-header-cell', 'fc-resource'], elAttrs: {
                    role: 'columnheader',
                    colSpan: props.colSpan,
                }, resource: props.resource, date: props.date
            }, (InnerContent) => (y("div", {className: "fc-scrollgrid-sync-inner"},
                y(InnerContent, {
                    elTag: "span", elClasses: [
                        'fc-col-header-cell-cushion',
    ...
    class ResourceDayHeader extends BaseComponent {
        ...
        renderResourceRow(resources, date) {
            let resourceCells = resources.map((resource) => (y(ResourceCell, {
                key: resource.id,
                resource: resource,
                colSpan: 1,
                date: date
        ...
        renderDayAndResourceRows(dates, dateFormat, todayRange, resources) {
            ...
            for (let date of dates) {
                ...
                for (let resource of resources) {
                    resourceCells.push(y(ResourceCell, {
        ...
        renderDateCell(date, dateFormat, todayRange, colSpan, resource, isSticky) {
            ...
            return props.datesRepDistinctDays ? (y(TableDateCell, {
            ...
            })) : (y(TableDowCell // we can't leverage the pure-componentness becausae the extra* props are new every time :(
                , {
    ...
    */
    ...
    class ResourceDayTableView extends TableView {
        ...
        render() {
            ...
            let headerContent = options.dayHeaders && (y(ResourceDayHeader, {
                ref: this.headerRef,
                resources: resources,
                dateProfile: props.dateProfile,
            ...
            let bodyContent = (contentArg) => (y(ResourceDayTable, {
                ref: this.tableRef,
                dateProfile: props.dateProfile,
    ...
    class ResourceDayTimeCols extends DateComponent {
        ...
        render() {
            ...
            return ( // TODO: would move this further down hierarchy, but sliceNowDate needs it
                y(NowTimer, {unit: options.nowIndicator ? 'minute' : 'day'}, (nowDate, todayRange) => (y(TimeCols, Object.assign({ref: this.timeColsRef}, this.joiner.joinProps(slicedProps, resourceDayTableModel), {
                    dateProfile: dateProfile,
                    axis: props.axis,
                    slotDuration: props.slotDuration,
                    slatMetas: props.slatMetas,
    ...
    class ResourceDayTimeColsView extends TimeColsView {
        ...
        render() {
            ...
            let allDayContent = (options.allDaySlot !== false) && ((contentArg) => (y(ResourceDayTable, Object.assign({}, splitProps.allDay, {
                dateProfile: dateProfile,
                resourceDayTableModel: resourceDayTableModel,
                nextDayThreshold: options.nextDayThreshold,
                tableMinWidth: contentArg.tableMinWidth,
            ...
            let timeGridContent = (contentArg) => (y(ResourceDayTimeCols, Object.assign({}, splitProps.timed, {
                dateProfile: dateProfile,
                axis: hasAttachedAxis,
                slotDuration: options.slotDuration,
                slatMetas: slatMetas,
    ...
    */
    ...
    class SpreadsheetIndividualCell extends BaseComponent {
        ...
        render() {
            ...
            }, (InnerContent) => (y("div", {className: "fc-datagrid-cell-frame", style: {height: props.innerHeight}},
                y("div", {className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner"},
                    colSpec.isMain && (y(ExpanderIcon, {
                        depth: props.depth,
    ...
    class SpreadsheetGroupCell extends BaseComponent {
        render() {
            ...
            return (y(ContentContainer, {
                ...
                didMount: colSpec.cellDidMount,
                willUnmount: colSpec.cellWillUnmount
            }, (InnerContent) => (y("div", {className: "fc-datagrid-cell-frame fc-datagrid-cell-frame-liquid"},
    ...
    class SpreadsheetRow extends BaseComponent {
        render() {
            ...
            return (y("tr", {role: "row"}, props.colSpecs.map((colSpec, i) => {
                ...
                return (y(SpreadsheetIndividualCell, {
                    key: i,
                    colSpec: colSpec,
                    resource: resource,
                    fieldValue: fieldValue,
            ...
            return (y("tr", {role: "row"},
                y(ContentContainer, {
                    ...
                    willUnmount: spec.labelWillUnmount
                        ...
                        style: {height: props.innerHeight}
                    },
    ...
    class SpreadsheetHeader extends BaseComponent {
        ...
        render() {
            ...
            rowNodes.push(y("tr", {key: "row", role: "row"}, colSpecs.map((colSpec, i) => {
                ...
                }, (InnerContent) => (y("div", {className: "fc-datagrid-cell-frame", style: {height: rowInnerHeight}},
                    y("div", {className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner"},
    ...
    class DividerRow extends BaseComponent {
        render() {
            ...
            return (y("tr", {ref: props.elRef},
                ...
                }, (InnerContainer) => (y(InnerContainer, {elTag: "div", elStyle: {height: props.innerHeight}})))));
        }
    }
    ...
    class ResourceTimelineView extends BaseComponent {
        ...
        render() {
            ...
            return (y(ViewContainer, {
                ...
                y(ResourceTimelineViewLayout, {
                    ref: this.layoutRef,
                    forPrint: props.forPrint,
                    isHeightAuto: props.isHeightAuto,
                    spreadsheetCols: buildSpreadsheetCols(colSpecs, state.spreadsheetColWidths, ''),
                    spreadsheetHeaderRows: (contentArg) => (y(SpreadsheetHeader // TODO: rename to SpreadsheetHeaderRows
                        , {
                    ...
                    spreadsheetBodyRows: (contentArg) => (y(_, null, this.renderSpreadsheetRows(rowNodes, colSpecs, contentArg.rowSyncHeights))),
                    timeCols: slatCols,
                    timeHeaderContent: (contentArg) => (y(TimelineHeader, {
                        clientWidth: contentArg.clientWidth,
                        clientHeight: contentArg.clientHeight,
                        tableMinWidth: contentArg.tableMinWidth,
                        tableColGroupNode: contentArg.tableColGroupNode,
                    ...
                    timeBodyContent: (contentArg) => (y(ResourceTimelineGrid, {
                        dateProfile: props.dateProfile,
                        clientWidth: contentArg.clientWidth,
                        clientHeight: contentArg.clientHeight,
                        tableMinWidth: contentArg.tableMinWidth,

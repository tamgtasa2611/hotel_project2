            ...
            <div class="row h-auto py-5 g-4">
                ...
                <div class="col-12 col-lg-8 load-hidden fade-in">
                    <div class="bg-dark p-4 shadow-lg  ">
                        ...
                        <div>
                            <div class="fw-bold bg-dark   -primary  ps-2 mb-2">
                            ...
                            <div
                                class="fw-bold bg-dark   -primary  ps-2 mb-2 mt-3">
                ...
                <div class="col-12 col-lg-4 load-hidden fade-in">
                    <div class="p-4 bg-dark shadow-lg   h-100 d-flex flex-column">
                        ...
                        <div>
                            ...
                            <a class="btn btn-secondary   w-100 mb-3 spinner-btn"
                            ...
                            <form action="{{route('guest.vnpay')}}" method="POST" class="m-0">
                                ...
                                <button type="submit" name="redirect"
                                        class="btn btn-outline-primary  w-100 spinner-btn">Banking
                                </button>
                            </form>
                        </div>
                    </div>

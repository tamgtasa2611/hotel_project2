        ...
        <form method="post" action="{{ route('admin.payments.store') }}" enctype="multipart/form-data"
                ...
                <div class="col-12 col-xl-6">
                    ...
                    <div class="p-4 col-12 ">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <textarea name="note" id="note" class="form-control">Đặt cọc/Thanh toán còn lại/Thanh toán dịch vụ của khách hàng ... cho đặt phòng #... </textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between justify-content-md-start p-4">
                ...
                <button type="submit" class="btn btn-primary px-3 tran-3">
                    <i class="me-2 bi bi-floppy"></i>Thêm
                </button>
            </div>
        </form>
    </div>

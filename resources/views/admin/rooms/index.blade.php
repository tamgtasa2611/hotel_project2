    ...
    <div class="bg-white  shadow-sm  border rounded-3 overflow-hidden">
        <div class="p-4 d-flex flex-column flex-md-row justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center justify-content-start justify-content-md-end">
                <a href="{{ route('admin.rooms.create') }}" class="d-flex align-items-center btn btn-primary">
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <a class="btn btn-outline-danger  dlt-btn" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal1" data-id={{ $room->id }}>
                        ...
                        <div class="modal-content">
                            <form method="post" action="{{ route('admin.rooms.destroy') }}">
                                ...
                                <div class="modal-body">
                                    Bạn sẽ không thể hoàn tác! <input id="id" name="id" hidden

<title>Sửa món ăn - Skyrim Hotel</title>
<x-adminLayout>
    ...
    <div class="bg-white shadow-sm border rounded-3 overflow-hidden">
        ...
        <hr class="m-0">
        {{-- FORM  --}}
        <form method="post" action="{{ route('admin.foodItems.update', $foodItem) }}" enctype="multipart/form-data"
              class="m-0">
            @csrf
            @method('PUT')
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="number" id="price" name="price" class="form-control"
                                       value="{{$foodItem->price}}" min="0" step="0.01"
                                       required/>
                            </div>
                        </div>
                        @if ($errors->has('price'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <textarea id="description" name="description"
                                          class="form-control">{{$foodItem->description}}</textarea>
                            </div>
                        </div>
